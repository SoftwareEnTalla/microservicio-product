...
import { PriceTypeCreatedEvent } from './pricetypecreated.event';
import { PriceTypeUpdatedEvent } from './pricetypeupdated.event';
import { PriceTypeDeletedEvent } from './pricetypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'price-type-created': createEventDefinition('price-type-created', PriceTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['price-type-created']),
  'price-type-updated': createEventDefinition('price-type-updated', PriceTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['price-type-updated']),
  'price-type-deleted': createEventDefinition('price-type-deleted', PriceTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['price-type-deleted']),
