...
import { AppliesToCreatedEvent } from './appliestocreated.event';
import { AppliesToUpdatedEvent } from './appliestoupdated.event';
import { AppliesToDeletedEvent } from './appliestodeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'applies-to-created': createEventDefinition('applies-to-created', AppliesToCreatedEvent, EVENT_DEFINITION_OVERRIDES['applies-to-created']),
  'applies-to-updated': createEventDefinition('applies-to-updated', AppliesToUpdatedEvent, EVENT_DEFINITION_OVERRIDES['applies-to-updated']),
  'applies-to-deleted': createEventDefinition('applies-to-deleted', AppliesToDeletedEvent, EVENT_DEFINITION_OVERRIDES['applies-to-deleted']),
