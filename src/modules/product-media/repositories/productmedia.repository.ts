...
import { logger } from '@core/logs/logger';
  ...
  export class ProductMediaRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ProductMedia[], number]> {
      logger.info('Ready to findByField ProductMedia on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ProductMedia with id:  was finded on repository:', instance);
