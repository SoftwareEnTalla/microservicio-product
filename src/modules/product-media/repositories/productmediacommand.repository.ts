...
export class ProductMediaCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: ProductMedia): Promise<ProductMedia> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvt1 = new ProductMediaCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: ProductMedia[]): Promise<ProductMedia[]> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvts2 = result.map((el)=>new ProductMediaCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      const __dualEvt3 = new ProductMediaUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            const __dualEvt4 = new ProductMediaUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       const __dualEvt5 = new ProductMediaDeletedEvent(id, {
        instance: entity,
        metadata: {
