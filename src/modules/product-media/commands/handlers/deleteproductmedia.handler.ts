...
import { DeleteProductMediaCommand } from "../deleteproductmedia.command";
import { ProductMediaCommandService } from "../../services/productmediacommand.service";

@CommandHandler(DeleteProductMediaCommand)
export class DeleteProductMediaHandler
  implements ICommandHandler<DeleteProductMediaCommand>
{
  constructor(
    private readonly commandService: ProductMediaCommandService
  ) {}
  async execute(command: DeleteProductMediaCommand) {
