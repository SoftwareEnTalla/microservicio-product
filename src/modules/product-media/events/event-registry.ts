...
import { ProductMediaCreatedEvent } from './productmediacreated.event';
import { ProductMediaUpdatedEvent } from './productmediaupdated.event';
import { ProductMediaDeletedEvent } from './productmediadeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-media-created': createEventDefinition('product-media-created', ProductMediaCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-media-created']),
  'product-media-updated': createEventDefinition('product-media-updated', ProductMediaUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-media-updated']),
  'product-media-deleted': createEventDefinition('product-media-deleted', ProductMediaDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-media-deleted']),
