...
import { PromotionTypeCreatedEvent } from './promotiontypecreated.event';
import { PromotionTypeUpdatedEvent } from './promotiontypeupdated.event';
import { PromotionTypeDeletedEvent } from './promotiontypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'promotion-type-created': createEventDefinition('promotion-type-created', PromotionTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['promotion-type-created']),
  'promotion-type-updated': createEventDefinition('promotion-type-updated', PromotionTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['promotion-type-updated']),
  'promotion-type-deleted': createEventDefinition('promotion-type-deleted', PromotionTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['promotion-type-deleted']),
