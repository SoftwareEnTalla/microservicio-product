...
@Module({
  controllers: [ProductRelationshipCommandController],
  providers: [
  ...
  exports: [ProductRelationshipAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthProductRelationshipModule {}
