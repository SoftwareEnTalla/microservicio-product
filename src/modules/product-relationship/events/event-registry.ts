...
import { ProductRelationshipCreatedEvent } from './productrelationshipcreated.event';
import { ProductRelationshipUpdatedEvent } from './productrelationshipupdated.event';
import { ProductRelationshipDeletedEvent } from './productrelationshipdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-relationship-created': createEventDefinition('product-relationship-created', ProductRelationshipCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-relationship-created']),
  'product-relationship-updated': createEventDefinition('product-relationship-updated', ProductRelationshipUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-relationship-updated']),
  'product-relationship-deleted': createEventDefinition('product-relationship-deleted', ProductRelationshipDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-relationship-deleted']),
