...
import { ProductPriceCreatedEvent } from './productpricecreated.event';
import { ProductPriceUpdatedEvent } from './productpriceupdated.event';
import { ProductPriceDeletedEvent } from './productpricedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-price-created': createEventDefinition('product-price-created', ProductPriceCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-price-created']),
  'product-price-updated': createEventDefinition('product-price-updated', ProductPriceUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-price-updated']),
  'product-price-deleted': createEventDefinition('product-price-deleted', ProductPriceDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-price-deleted']),
