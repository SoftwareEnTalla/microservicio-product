...
import { ProductVariantCreatedEvent } from './productvariantcreated.event';
import { ProductVariantUpdatedEvent } from './productvariantupdated.event';
import { ProductVariantDeletedEvent } from './productvariantdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-variant-created': createEventDefinition('product-variant-created', ProductVariantCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-variant-created']),
  'product-variant-updated': createEventDefinition('product-variant-updated', ProductVariantUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-variant-updated']),
  'product-variant-deleted': createEventDefinition('product-variant-deleted', ProductVariantDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-variant-deleted']),
