...
export class ProductVariantService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<ProductVariant[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<ProductVariant[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<ProductVariant[]> {
  ...
  async update(id: string, partialEntity: Partial<ProductVariant>): Promise<ProductVariant | null> {
