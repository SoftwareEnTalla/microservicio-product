...
import { logger } from '@core/logs/logger';
  ...
  export class ProductVariantRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ProductVariant[], number]> {
      logger.info('Ready to findByField ProductVariant on repository:',where);
    ...
    async findOne(where?: Record<string, any>): Promise<ProductVariant | null> {
      const tmp: FindOptionsWhere<ProductVariant> = where as FindOptionsWhere<ProductVariant>;
      logger.info('Ready to findOneBy ProductVariant on repository with conditions:', tmp);
    ...
    async update(
        ...
        logger.info('Updated instance of ProductVariant with id:  was finded on repository:', instance);
