...
import { DeleteProductVariantCommand } from "../deleteproductvariant.command";
...
{
  constructor(
    private readonly commandService: ProductVariantCommandService
  ) {}
  async execute(command: DeleteProductVariantCommand) {
