...
import { MediaTypeCreatedEvent } from './mediatypecreated.event';
import { MediaTypeUpdatedEvent } from './mediatypeupdated.event';
import { MediaTypeDeletedEvent } from './mediatypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'media-type-created': createEventDefinition('media-type-created', MediaTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['media-type-created']),
  'media-type-updated': createEventDefinition('media-type-updated', MediaTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['media-type-updated']),
  'media-type-deleted': createEventDefinition('media-type-deleted', MediaTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['media-type-deleted']),
