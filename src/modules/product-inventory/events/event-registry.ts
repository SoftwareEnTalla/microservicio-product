...
import { ProductInventoryCreatedEvent } from './productinventorycreated.event';
import { ProductInventoryUpdatedEvent } from './productinventoryupdated.event';
import { ProductInventoryDeletedEvent } from './productinventorydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-inventory-created': createEventDefinition('product-inventory-created', ProductInventoryCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-inventory-created']),
  'product-inventory-updated': createEventDefinition('product-inventory-updated', ProductInventoryUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-inventory-updated']),
  'product-inventory-deleted': createEventDefinition('product-inventory-deleted', ProductInventoryDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-inventory-deleted']),
