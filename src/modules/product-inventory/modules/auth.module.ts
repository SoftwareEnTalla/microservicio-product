...
@Module({
  controllers: [ProductInventoryCommandController],
  providers: [
  ...
  exports: [ProductInventoryAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthProductInventoryModule {}
