...
@Module({
  controllers: [ProductPromotionCommandController],
  providers: [
  ...
  exports: [ProductPromotionAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthProductPromotionModule {}
