...
import { ProductPromotionCreatedEvent } from './productpromotioncreated.event';
import { ProductPromotionUpdatedEvent } from './productpromotionupdated.event';
import { ProductPromotionDeletedEvent } from './productpromotiondeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-promotion-created': createEventDefinition('product-promotion-created', ProductPromotionCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-promotion-created']),
  'product-promotion-updated': createEventDefinition('product-promotion-updated', ProductPromotionUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-promotion-updated']),
  'product-promotion-deleted': createEventDefinition('product-promotion-deleted', ProductPromotionDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-promotion-deleted']),
