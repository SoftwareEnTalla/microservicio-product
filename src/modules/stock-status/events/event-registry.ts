...
import { StockStatusCreatedEvent } from './stockstatuscreated.event';
import { StockStatusUpdatedEvent } from './stockstatusupdated.event';
import { StockStatusDeletedEvent } from './stockstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'stock-status-created': createEventDefinition('stock-status-created', StockStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['stock-status-created']),
  'stock-status-updated': createEventDefinition('stock-status-updated', StockStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['stock-status-updated']),
  'stock-status-deleted': createEventDefinition('stock-status-deleted', StockStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['stock-status-deleted']),
