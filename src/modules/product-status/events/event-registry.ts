...
import { ProductStatusCreatedEvent } from './productstatuscreated.event';
import { ProductStatusUpdatedEvent } from './productstatusupdated.event';
import { ProductStatusDeletedEvent } from './productstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-status-created': createEventDefinition('product-status-created', ProductStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-status-created']),
  'product-status-updated': createEventDefinition('product-status-updated', ProductStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-status-updated']),
  'product-status-deleted': createEventDefinition('product-status-deleted', ProductStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-status-deleted']),
