...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class TargetEntityTypeQueryRepository {

    //Constructor del repositorio de datos: TargetEntityTypeQueryRepository
    constructor(
    ...
    async findWithPagination(
      ...
      logger.info('Ready to findWithPagination TargetEntityType on repository:', options);
      return this.repository.find(options);
    }
    ...
    async findAndCount(where?: Record<string, any>): Promise<[TargetEntityType[], number]> {
      logger.info('Ready to findAndCount TargetEntityType on repository:',where);
      let result= this.repository.findAndCount({
        where: where,
      });
      logger.info('Was counted  instances of TargetEntityType on repository:',result);
      return result;
    }
