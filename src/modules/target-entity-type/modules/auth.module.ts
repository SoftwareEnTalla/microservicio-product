...
@Module({
  controllers: [TargetEntityTypeCommandController],
  providers: [
  ...
  exports: [TargetEntityTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthTargetEntityTypeModule {}
