...
import { TargetEntityTypeCreatedEvent } from './targetentitytypecreated.event';
import { TargetEntityTypeUpdatedEvent } from './targetentitytypeupdated.event';
import { TargetEntityTypeDeletedEvent } from './targetentitytypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'target-entity-type-created': createEventDefinition('target-entity-type-created', TargetEntityTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['target-entity-type-created']),
  'target-entity-type-updated': createEventDefinition('target-entity-type-updated', TargetEntityTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['target-entity-type-updated']),
  'target-entity-type-deleted': createEventDefinition('target-entity-type-deleted', TargetEntityTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['target-entity-type-deleted']),
