...
@Module({
  controllers: [ProductAttributeCommandController],
  providers: [
  ...
  exports: [ProductAttributeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthProductAttributeModule {}
