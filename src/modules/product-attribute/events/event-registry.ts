...
import { ProductAttributeCreatedEvent } from './productattributecreated.event';
import { ProductAttributeUpdatedEvent } from './productattributeupdated.event';
import { ProductAttributeDeletedEvent } from './productattributedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-attribute-created': createEventDefinition('product-attribute-created', ProductAttributeCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-attribute-created']),
  'product-attribute-updated': createEventDefinition('product-attribute-updated', ProductAttributeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-attribute-updated']),
  'product-attribute-deleted': createEventDefinition('product-attribute-deleted', ProductAttributeDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-attribute-deleted']),
