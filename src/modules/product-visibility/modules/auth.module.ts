...
@Module({
  controllers: [ProductVisibilityCommandController],
  providers: [
  ...
  exports: [ProductVisibilityAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthProductVisibilityModule {}
