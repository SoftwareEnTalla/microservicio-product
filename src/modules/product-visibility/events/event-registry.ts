...
import { ProductVisibilityCreatedEvent } from './productvisibilitycreated.event';
import { ProductVisibilityUpdatedEvent } from './productvisibilityupdated.event';
import { ProductVisibilityDeletedEvent } from './productvisibilitydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-visibility-created': createEventDefinition('product-visibility-created', ProductVisibilityCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-visibility-created']),
  'product-visibility-updated': createEventDefinition('product-visibility-updated', ProductVisibilityUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-visibility-updated']),
  'product-visibility-deleted': createEventDefinition('product-visibility-deleted', ProductVisibilityDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-visibility-deleted']),
