...
import { logger } from '@core/logs/logger';
  ...
  export class ProductVisibilityRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ProductVisibility[], number]> {
      logger.info('Ready to findByField ProductVisibility on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ProductVisibility with id:  was finded on repository:', instance);
