...
import { ProductSpecificationCreatedEvent } from './productspecificationcreated.event';
import { ProductSpecificationUpdatedEvent } from './productspecificationupdated.event';
import { ProductSpecificationDeletedEvent } from './productspecificationdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'product-specification-created': createEventDefinition('product-specification-created', ProductSpecificationCreatedEvent, EVENT_DEFINITION_OVERRIDES['product-specification-created']),
  'product-specification-updated': createEventDefinition('product-specification-updated', ProductSpecificationUpdatedEvent, EVENT_DEFINITION_OVERRIDES['product-specification-updated']),
  'product-specification-deleted': createEventDefinition('product-specification-deleted', ProductSpecificationDeletedEvent, EVENT_DEFINITION_OVERRIDES['product-specification-deleted']),
