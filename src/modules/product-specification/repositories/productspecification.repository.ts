...
import { logger } from '@core/logs/logger';
  ...
  export class ProductSpecificationRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ProductSpecification[], number]> {
      logger.info('Ready to findByField ProductSpecification on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ProductSpecification with id:  was finded on repository:', instance);
