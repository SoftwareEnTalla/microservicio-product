...
export class ProductSpecificationCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: ProductSpecification): Promise<ProductSpecification> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvt1 = new ProductSpecificationCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: ProductSpecification[]): Promise<ProductSpecification[]> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvts2 = result.map((el)=>new ProductSpecificationCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      const __dualEvt3 = new ProductSpecificationUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            const __dualEvt4 = new ProductSpecificationUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       const __dualEvt5 = new ProductSpecificationDeletedEvent(id, {
        instance: entity,
        metadata: {
