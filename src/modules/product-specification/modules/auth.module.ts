...
@Module({
  controllers: [ProductSpecificationCommandController],
  providers: [
  ...
  exports: [ProductSpecificationAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthProductSpecificationModule {}
