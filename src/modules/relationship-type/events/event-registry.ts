...
import { RelationshipTypeCreatedEvent } from './relationshiptypecreated.event';
import { RelationshipTypeUpdatedEvent } from './relationshiptypeupdated.event';
import { RelationshipTypeDeletedEvent } from './relationshiptypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'relationship-type-created': createEventDefinition('relationship-type-created', RelationshipTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['relationship-type-created']),
  'relationship-type-updated': createEventDefinition('relationship-type-updated', RelationshipTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['relationship-type-updated']),
  'relationship-type-deleted': createEventDefinition('relationship-type-deleted', RelationshipTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['relationship-type-deleted']),
