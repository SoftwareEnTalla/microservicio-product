...
@Module({
  controllers: [RelationshipTypeCommandController],
  providers: [
  ...
  exports: [RelationshipTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthRelationshipTypeModule {}
