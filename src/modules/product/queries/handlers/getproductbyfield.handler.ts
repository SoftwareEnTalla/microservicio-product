...
import { GetProductByFieldQuery } from '../getproductbyfield.query';
import { ProductQueryService } from '../../services/productquery.service';

@QueryHandler(GetProductByFieldQuery)
export class GetProductByFieldHandler implements IQueryHandler<GetProductByFieldQuery> {
  constructor(private readonly queryService: ProductQueryService) {}

  async execute(query: GetProductByFieldQuery) {
